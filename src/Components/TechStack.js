                                        ...
                                        <div className="thumb">
                                            <a href="../img/first_big_item.jpg" data-lightbox="image-1"><div className="hover-effect">
                                                <div className="hover-content">
                                                    ...
                                                    <p> Individual award for my contribution to the team.</p>
                                                </div>
                                            </div></a>
                                            <div className="image">
                                        ...
                                        <div className="thumb">
                                            <a href="../img/second_big_item.jpg" data-lightbox="image-1"><div className="hover-effect">
                                                <div className="hover-content">
                                                    ...
                                                    <p>LinkedIn Learning certificate for MERN Stack Development Course</p>
                                                </div>
                                            </div></a>
                                            <div className="image">
                                        ...
                                        <div className="thumb">
                                            <a href="../img/third_big_item.jpg" data-lightbox="image-1"><div className="hover-effect">
                                                <div className="hover-content">
                                                    ...
                                                    <p>Team award for Accessibility Project.</p>
                                                </div>
                                            </div></a>
                                            <div className="image">
                                        ...
                                        <div className="thumb">
                                            <a href="../img/fourth_big_item.jpg" data-lightbox="image-1"><div className="hover-effect">
                                                <div className="hover-content">
                                                    ...
                                                    <p>Udemy "R Programming for Data Science" certification</p>
                                                </div>
                                            </div></a>
                                            <div className="image">
                                    ...
                                    <div className="item">
                                        <div className="thumb">
                                            <a href="../img/sixth_big_item.jpg" data-lightbox="image-1"><div className="hover-effect">
                                                <div className="hover-content">
                                                    <h2>Udemy Certification</h2>
                                                    <p>Udemy Certificate for "Java Full Stack with React" Course</p>
                                                </div>
                                            </div></a>
                                            <div className="image">
