            ...
            <div className="content fifth-content">
                <div className="container-fluid">
                    <div className = "row" style = {{"paddingLeft":"24px"}}>
                        <div className = "col-md-3 col-xs-3"><a href = "http://linkedin.com/in/swagat-dash-465b5b129"  target="_blank" ><i className="fab fa-linkedin social-tag" style = {{"fontSize": "4.73em","float":"left","marginLeft":"10px","color":"#fff"}}></i></a></div>
                        <div className = "col-md-3 col-xs-3"><a href = "https://github.com/swagatdash95"  target="_blank" ><i className= "fab fa-github social-tag" style = {{"fontSize": "4.73em","float":"left","color":"#fff"}}></i></a></div>
                        <div className = "col-md-3 col-xs-3"><a href= "https://instagram.com/swagatdash1?r=nametag"  target="_blank" ><i className="fab fa-instagram social-tag" style = {{"fontSize": "4.73em", "position":"relative","left": "-6%","color":"#fff"}}></i></a></div>
                        <div className = "col-md-3 col-xs-3"><a href = "https://www.facebook.com/swagat.dash.773"  target="_blank" ><i className="fab fa-facebook-square social-tag" style = {{"fontSize": "4.73em","float":"right","marginRight":"10px","color":"#fff"}}></i></a></div>
                    </div>
                    <div className = "row" style = {{"marginTop":"15px"}}>
                        <div>
                            <div className = "row-text">Hire me,<span style = {{"color":"#ffc800"}}> eh?</span></div>
                            <button className = "btn" onClick = {downloadResume} style = {{"width":"23%","height":"25px","fontSize":"10px","padding":"0px"}}><i className="fas fa-download"></i> Resume</button>
                        </div>
                    </div>
                    <div className = "row">
